...
var _class = function () {
    ...
    _class.prototype.getCurrentPages = function (_getCurrentPages) {
    ...
    _class.prototype.$on = function $on(evtName, fn) {
        var _this7 = this;
    ...
    _class.prototype.$once = function $once(evtName, fn) {
        var self = this;
    ...
    _class.prototype.$off = function $off(evtName, fn) {
        var _this8 = this;
    ...
    _class.prototype.$nextTick = function $nextTick(fn) {
        var _this10 = this;
