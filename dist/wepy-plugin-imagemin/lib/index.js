    ...
    _class.prototype.apply = function apply(op) {
        ...
        if (!setting.filter.test(op.file)) {
            ...
            (0, _imagemin2.default)([op.file], '', {
                plugins: [(0, _imageminMozjpeg2.default)(this.setting.config.jpg), (0, _imageminPngquant2.default)(this.setting.config.png), (0, _imageminSvgo2.default)(this.setting.config.svg)]
            }).then(function (files) {
